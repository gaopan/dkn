<template>
  <div class="product-scroller" ref="wrapper">
    <div class="product-scroller-content">
      <div class="product-scroller-item designed-for" v-if = "bDesignFor" ref="DesignForBlock">
        <p>{{productInfoDSM.DesignaedFor}}</p>
        <p>{{productInfoDSM.Catchline}}</p>
      </div>
      <div class="product-scroller-item product-benefits" ref="ProdBenefitBlock">
      ...
      <div class="product-scroller-item product-scorce" v-if ="bProductBenefit" ref="UserReviewsBlock">
      ...
      <div class="product-scroller-item product-tech" v-if = "bProdConceptTech" ref="ConceptTechBlock">
      ...
      <div class="product-scroller-item tech-information" v-if = "bTechInfo" ref="TechInfoBlock">
