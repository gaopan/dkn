<template>
  <div class="product-scroller" ref="wrapper">
    <div class="product-scroller-content">
      <div class="product-scroller-item designed-for" ref="DesignForBlock">
      ...
      <div class="product-scroller-item product-scorce" ref="UserReviewsBlock">
      ...
      <div class="product-scroller-item product-tech" ref="ConceptTechBlock">
      ...
      <div class="product-scroller-item tech-information" ref="TechInfoBlock">
