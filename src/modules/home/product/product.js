...
export default {
  ...
  beforeDestroy() {
		// let doc = document;
		// console.log(doc.querySelector("#scrollnavTab"))
    ...
    selectProductSize(args) {
      ...
      this.fnUpdateStock_QR_UserReview(undefined, this.productInfoByCurrentColor.modelCode, itemCode, this.lang)
    },
    ...
    initPageData(lang) {
      ProductApi.getProductInfo(this.rfid, undefined, lang).then(res => {
        ...
        this.fnUpdateStock_QR_UserReview(undefined, this.productInfoByCurrentColor.modelCode, this.productInfoByCurrentColor.items[0].itemCode, lang);
