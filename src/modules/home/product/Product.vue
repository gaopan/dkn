			...
			<div class="product-color-option">
				...
				<ul class="product-color-list clearfix" ref = "ColorOption">
					<li 
						...
						@click = "selectProductColor(color,colorIndex)">
			...
			<div class="product-size-option">
				...
				<div class="product-size-wrapper">
					<div class="product-size-select" ref = "SizeOption" @click = "monitorClick_Color_QR_Select('SizeOption')">
						...
						<custom-select 
							v-else-if = "size_image_colorName.sizeOptions.length"
							:label = "sizeSelected.label"
							:subLabel = "sizeSelected.stock"
							:lang = "lang"
							:options = "size_image_colorName.sizeOptions" 
...
-->
			...
			<vue-better-scroll :lang = "lang" :list = "navTabList_" :data = "productInfoDataDatBase" :partialData = "productReviews">
				<ul class="content">
				    	  <li v-for="(item, index) in navTabList_" :key="index">
